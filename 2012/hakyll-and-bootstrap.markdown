...
<p class="update">It's probably no surprise, but diving straight into Haskell
wasn't the smoothest transition; without a better understanding of the language
as a whole, I spent more time fiddling with the code than writing.  I'm much
more comfortable with Python, so I've moved the site over to Flask.</p>
...
GitHub](http://github.com/akshayjshah/datahackermd); otherwise, send me a
